...
Spree::Order.class_eval do
  ...
  def bill_address_id=(id)
    ...
    if address && address.user_id == self.user_id
      ...
      self.user.update_attribute(:bill_address_id, address.id) if user.present?
  ...
  def bill_address_attributes=(attributes)
    ...
    self.user.bill_address = self.bill_address if user.present?
  end
  ...
  def ship_address_id=(id)
    ...
    if address && address.user_id == self.user_id
      ...
      self.user.update_attribute(:ship_address_id, address.id) if user.present?
  ...
  def ship_address_attributes=(attributes)
    ...
    user.ship_address = ship_address if user.present?
  end
